...
<div className='max-w-[1170px] px-5 mx-auto'>
  ...
  <div className='pb-[50px] px-[30px] rounded-md'>
    ...
    <div className='text-center mt-4'>
      <h3 className='text-headingColor text-[18px] leading-[30px] font-bold '>{userData.name}</h3>
    ...
    <div className='mt-[50px] md:mt-[100px] '>
      <button onClick={handleLogout} className='w-full bg-[#181A1E] p-3 text-[16px] leading-7 rounded-md text-white ' >Log Out</button>
