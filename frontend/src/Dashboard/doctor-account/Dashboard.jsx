              ...
              {data.isApproved === 'pending' && (
                <div className='flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg'>
                  ...
                  <div className='ml-3 text-sm font-medium'>
                    To get verified, you need to complete your profile. 
                  </div>
                </div>
              )}
              <div className='mt-8'>
                    ...
                    <div>
                      <span className='bg-[#CCF0F3] text-irisBlueColor py-4 px-4 lg:py-2 lg:px-6 rounded text-[12px] leading-4 lg:text-[16px] lg:leading-6 font-semibold'>
                        ...
                        <div className='flex items-center gap-[6px]'>
                          ...
                          <span className='text-[14px] leading-5 lg:text-[16px] lg:leading-6 font-semibold text-textColor'>({data.totalRating})</span>
                        </div>
