  ...
  return (
    ...
    <div className='mt-2 lg:mt-4 flex items-center justify-between'>
        ...
        <div className='flex items-center gap-[6px]'>
            ...
            <span className='text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-headingColor'>({gender})</span>
    ...
    <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
        <div>
            ...
            <p className='text-[14px] leading-6 font-[400] text-textColor '> {rec}</p>
        </div>
